...
This project is designed to evaluate your coding skills in web development.  
You are required to build a simple web application that consumes the [OMDB API](http://www.omdbapi.com/).  
...
After development, you must deploy the project using [GitHub Pages](https://pages.github.com).  
Projects that are not deployed to GitHub Pages will **not be evaluated** and will receive **0 points**.  

You must **fork this repository** and upload your solution to your fork.  
Do **not** attempt to push changes directly to this repository or any of its branches.
...
2. **Security**  
   - Do not expose your OMDB API key in the frontend code.  
   - If you use environment variables in a backend, provide a sample configuration file.
...
- A public GitHub repository containing your project code.  
